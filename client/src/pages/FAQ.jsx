...
const faqs = [
  { q: 'What is Workspace?', a: 'Workspace is a minimal, secure platform for managing your team, users and workflows. It is built with modern technologies and designed to be fast and easy to use.' },
  ...
  { q: 'What is the difference between admin and user roles?', a: 'Admin users have access to the admin panel where they can manage all users and system settings. Regular users have access to their personal workspace dashboard.' },
  { q: 'How do I contact support?', a: 'You can reach us at support@workspace.com. We typically respond within 24 hours on business days.' },
]
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-16">
        <div className="mb-10">
          ...
          <p className="text-sm text-secondary mt-2">Everything you need to know about Workspace.</p>
        </div>
        ...
        <div className="mt-10 bg-zinc-50 rounded-2xl px-6 py-6 text-center">
          ...
          <a href="mailto:support@workspace.com" className="text-sm font-medium text-primary hover:underline mt-1 inline-block">
