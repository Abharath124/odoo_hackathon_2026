...
export default function Home() {
  ...
  const { logo, primary_color } = useSelector((state) => state.site)
  ...
  return (
    <div className="flex flex-col gap-6 pb-20">
      ...
      <button onClick={() => navigate('/trips/new')} className="fixed bottom-6 right-6 flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all" style={{ background: primary_color }}>
